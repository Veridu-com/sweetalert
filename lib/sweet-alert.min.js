...
d.text=a.text||h.text;d.html=a.html||h.html;d.type=a.type||h.type;d.customClass=a.customClass||d.customClass;d.allowOutsideClick=a.allowOutsideClick||h.allowOutsideClick;d.showCancelButton=void 0!==a.showCancelButton?a.showCancelButton:h.showCancelButton;d.closeOnConfirm=void 0!==a.closeOnConfirm?a.closeOnConfirm:h.closeOnConfirm;d.closeOnCancel=void 0!==a.closeOnCancel?a.closeOnCancel:h.closeOnCancel;d.timer=a.timer||h.timer;d.confirmButtonText=h.showCancelButton?"Confirm":h.confirmButtonText;d.confirmButtonText=
a.confirmButtonText||h.confirmButtonText;d.confirmButtonColor=a.confirmButtonColor||h.confirmButtonColor;d.cancelButtonText=a.cancelButtonText||h.cancelButtonText;d.imageUrl=a.imageUrl||h.imageUrl;d.imageSize=a.imageSize||h.imageSize;d.doneFunction=b||null;break;default:return g.console.error('Unexpected type of argument! Expected "string" or "object", got '+typeof a),!1}G(d);H();I();var l=p();a=function(a){var b=a||g.event,c=b.target||b.srcElement;a="confirm"===c.className;var e=q(l,"visible"),f=
d.doneFunction&&"true"===l.getAttribute("data-has-done-function");switch(b.type){case "mouseover":a&&(c.style.backgroundColor=w(d.confirmButtonColor,-.04));break;case "mouseout":a&&(c.style.backgroundColor=d.confirmButtonColor);break;case "mousedown":a&&(c.style.backgroundColor=w(d.confirmButtonColor,-.14));break;case "mouseup":a&&(c.style.backgroundColor=w(d.confirmButtonColor,-.04));break;case "focus":b=l.querySelector("button.confirm");c=l.querySelector("button.cancel");a?c.style.boxShadow="none":
...
else if("function"===typeof a.onclick)a.onclick()}};m.onblur=e;k.onblur=e;g.onfocus=function(){g.setTimeout(function(){void 0!==r&&(r.focus(),r=void 0)},0)}}function G(a){var b=p(),c=b.querySelector("h2"),e=b.querySelector("p"),d=b.querySelector("button.cancel"),f=b.querySelector("button.confirm");c.innerHTML=v(a.title).split("\n").join("<br>");a.text?(e.innerHTML=v(a.text||"").split("\n").join("<br>"),u(e)):a.html&&(e.innerHTML=a.html||"",u(e));a.customClass&&m(b,a.customClass);D(b.querySelectorAll(".icon"));
if(a.type){c=!1;for(e=0;e<E.length;e++)if(a.type===E[e]){c=!0;break}if(!c)return g.console.error("Unknown alert type: "+a.type),!1;c=b.querySelector(".icon."+a.type);u(c);switch(a.type){case "success":m(c,"animate");m(c.querySelector(".tip"),"animateSuccessTip");m(c.querySelector(".long"),"animateSuccessLong");break;case "error":m(c,"animateErrorIcon");m(c.querySelector(".x-mark"),"animateXMark");break;case "warning":m(c,"pulseWarning"),m(c.querySelector(".body"),"pulseWarningIns"),m(c.querySelector(".dot"),
"pulseWarningIns")}}if(a.imageUrl){c=b.querySelector(".icon.custom");c.style.backgroundImage="url("+a.imageUrl+")";u(c);var h=e=80;if(a.imageSize){var k=a.imageSize.split("x")[0],n=a.imageSize.split("x")[1];k&&n?(e=k,h=n,c.css({width:k+"px",height:n+"px"})):g.console.error("Parameter imageSize expects value with format WIDTHxHEIGHT, got "+a.imageSize)}c.setAttribute("style",c.getAttribute("style")+"width:"+e+"px; height:"+h+"px")}b.setAttribute("data-has-cancel-button",a.showCancelButton);a.showCancelButton?
d.style.display="inline-block":D(d);a.cancelButtonText&&(d.innerHTML=v(a.cancelButtonText));a.confirmButtonText&&(f.innerHTML=v(a.confirmButtonText));f.style.backgroundColor=a.confirmButtonColor;C(f,a.confirmButtonColor);b.setAttribute("data-allow-ouside-click",a.allowOutsideClick);b.setAttribute("data-has-done-function",a.doneFunction?!0:!1);b.setAttribute("data-timer",a.timer)}function w(a,b){a=String(a).replace(/[^0-9a-f]/gi,"");6>a.length&&(a=a[0]+a[0]+a[1]+a[1]+a[2]+a[2]);b=b||0;var c="#",e,
...
10);u(a);m(a,"showSweetAlert");k(a,"hideSweetAlert");x=f.activeElement;a.querySelector("button.confirm").focus();setTimeout(function(){m(a,"visible")},500);var b=a.getAttribute("data-timer");"null"!==b&&""!==b&&(a.timeout=setTimeout(function(){t()},b))}function t(){var a=p();F(f.querySelector(".sweet-overlay"),5);F(a,5);k(a,"showSweetAlert");m(a,"hideSweetAlert");k(a,"visible");var b=a.querySelector(".icon.success");k(b,"animate");k(b.querySelector(".tip"),"animateSuccessTip");k(b.querySelector(".long"),
...
10):parseInt(b.currentStyle.padding);b.style.left="";b.style.display="none";b="-"+parseInt(c/2+e)+"px";a.marginTop=b}var E=["error","warning","info","success"],h={title:"",text:"",html:"",type:null,allowOutsideClick:!1,showCancelButton:!1,closeOnConfirm:!0,closeOnCancel:!0,confirmButtonText:"OK",confirmButtonColor:"#AEDEF4",cancelButtonText:"Cancel",imageUrl:null,imageSize:null,timer:null},p=function(){return f.querySelector(".sweet-alert")},q=function(a,b){return(new RegExp(" "+b+" ")).test(" "+
a.className+" ")},m=function(a,b){q(a,b)||(a.className+=" "+b)},k=function(a,b){var c=" "+a.className.replace(/[\t\r\n]/g," ")+" ";if(q(a,b)){for(;0<=c.indexOf(" "+b+" ");)c=c.replace(" "+b+" "," ");a.className=c.replace(/^\s+|\s+$/g,"")}},v=function(a){var b=f.createElement("div");b.appendChild(f.createTextNode(a));return b.innerHTML},u=function(a){if(a&&!a.length)a.style.opacity="",a.style.display="block";else for(var b=0;b<a.length;++b){var c=a[b];c.style.opacity="";c.style.display="block"}},D=
